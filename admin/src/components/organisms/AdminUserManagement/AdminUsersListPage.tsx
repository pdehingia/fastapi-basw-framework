...
import { Modal, SearchBox } from '../../molecules';
...
export const AdminUsersListPage = () => {
  ...
  const totalCount = adminUsersData?.metadata?.total_items || 0;
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              <select
                ...
                onChange={(e) => handleFilterChange({ 
                  role: (e.target.value as AdminUser['role']) || undefined 
                })}
                value={filters.role || ''}
              >
            ...
            <div>
              <select
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                onChange={(e) => handleFilterChange({ 
                  status: (e.target.value as AdminUser['status']) || undefined 
                })}
