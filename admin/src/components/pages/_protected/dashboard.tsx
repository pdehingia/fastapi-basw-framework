/**
 * Dashboard Page Route - SIMPLIFIED FOR TESTING
 * Test dashboard to verify authentication flow
 */
      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Maya Admin Dashboard</h1>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{user?.full_name || 'Not available'}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Role</dt>
                  <dd className="mt-1 text-sm text-gray-900">{user?.role || 'Not available'}</dd>
                </div>
                <div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">Overview</dd>
                    </dl>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">Analytics</dd>
                    </dl>
                  </div>
                </div>
              </div>
