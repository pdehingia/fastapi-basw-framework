"""Artist verification management dependencies."""
...
def get_artist_verification_service(
    db: Annotated[Session, Depends(get_db)],
    current_admin: Annotated[AdminUser, Depends(get_current_admin_user)]
) -> ArtistVerificationService:
    """Get artist verification service with admin context."""
    return ArtistVerificationService(db, current_admin.id)